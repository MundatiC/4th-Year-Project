...
function play(){
    ...
    if(GameStatus == Status.start) {
        ...
        canvas.onclick = function(event){
            ...
            GRAVITY = 2;
            elementSort();
            alert("Hey, in this game, you must select the element presented by the cat (on the left side of the screen). You start with three lives, and for each missed element, you lose a life. For each correct element, you gain a point!\n\n Have fun! :) \n\n\nThis game was developed by Allex Lima, Daniel Bispo, Paulo Moraes, and Renan Barroncas, students of the 4th period (2015) of the Computer Engineering course at UniNorte Laureate.\n\nAdvisor: Prof. Dr. Rebecca Freire\n")
